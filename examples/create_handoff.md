...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-XXXX_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes, and seconds based on the current time, in 24-hour format (e.g. `13-00-00` for `1:00:00 pm`)
        - ENG-XXXX is the ticket number (replace with `general` if no ticket)
        - the second `ENG-XXXX` segment in the filename is omitted if there is no ticket
